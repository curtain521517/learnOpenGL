...
int main()
{
    ...
    //初始化shader
    Shader myShader("/Users/xufan/learnOpenGL/Transformations/shader01.vs", "/Users/xufan/learnOpenGL/Transformations/shader01.frag");
    gShader = &myShader;
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        trans = glm::translate(trans, glm::vec3(-0.5f, 0.5f, 0.0f));
        GLfloat scaleAmount = sin(glfwGetTime())/2 + 0.5;
